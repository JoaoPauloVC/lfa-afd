class ValidadorEmail:
    ...
    def validar(self, email):
        ...
        transicoes = {
            0: {'letra_numero': 1, 'caractere_especial': 1},  # Estado 0: Nome do usuário. Muda para Estado 1 com @
            1: {'letra_numero': 1, 'caractere_especial': 1, '@': 2},  # Estado 0: Nome do usuário. Muda para Estado 1 com @
